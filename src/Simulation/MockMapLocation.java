...
public class MockMapLocation
{
    ...
    public MockMapLocation(int x, int y, double rubble)
    {
        this.x = x;
        this.y = y;
        this.rubble = rubble;
    ...
    public MockMapLocation(int x, int y, double rubble, MockRobotPlayer robotPlayer)
    {
        this.x = x;
        this.y = y;
        this.rubble = rubble;
    ...
    public void setTerrain(double rubble)
    {
        this.rubble = rubble;
    }
